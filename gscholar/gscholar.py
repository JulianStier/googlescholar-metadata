...
def query(searchstr, outformat=FORMAT_BIBTEX, allresults=False, header: dict=HEADERS):
    ...
    query_modified = searchstr.replace(" ", "+")
    searchstr = '/scholar?hl=en&q='+quote(query_modified)+"&btnG="
